...
public enum ModArmorMaterials implements ArmorMaterial {
    REINFORCED_COPPER("reinforced_copper", 25, new int[]{3, 8, 6, 3}, 19, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 2f, 0.1f, () -> Ingredient.ofItems(ModItems.REINFORCED_COPPER_INGOT));
    ...
    public int getDurability(ArmorItem.Type type) {
        return this.BASE_DURABILITY[type.ordinal()] * durabilityMultiplier;
    }
    ...
    public String getName() {
        return KafCopper.MOD_ID + ':' + this.name;
    }
